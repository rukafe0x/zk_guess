...
PreConfirmedBlockWithTxs _$PreConfirmedBlockWithTxsFromJson(
    Map<String, dynamic> json) {
  return _PreConfirmedBlockWithTxs.fromJson(json);
}

/// @nodoc
mixin _$PreConfirmedBlockWithTxs {
  ...
  List<TxnWithHash> get transactions => throw _privateConstructorUsedError;

  /// Serializes this PreConfirmedBlockWithTxs to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PreConfirmedBlockWithTxs
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PreConfirmedBlockWithTxsCopyWith<PreConfirmedBlockWithTxs> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PreConfirmedBlockWithTxsCopyWith<$Res> {
  factory $PreConfirmedBlockWithTxsCopyWith(PreConfirmedBlockWithTxs value,
          $Res Function(PreConfirmedBlockWithTxs) then) =
      _$PreConfirmedBlockWithTxsCopyWithImpl<$Res, PreConfirmedBlockWithTxs>;
  @useResult
  $Res call(
...
/// @nodoc
class _$PreConfirmedBlockWithTxsCopyWithImpl<$Res,
        $Val extends PreConfirmedBlockWithTxs>
    implements $PreConfirmedBlockWithTxsCopyWith<$Res> {
  _$PreConfirmedBlockWithTxsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PreConfirmedBlockWithTxsImplCopyWith<$Res>
    implements $PreConfirmedBlockWithTxsCopyWith<$Res> {
  factory _$$PreConfirmedBlockWithTxsImplCopyWith(
          _$PreConfirmedBlockWithTxsImpl value,
          $Res Function(_$PreConfirmedBlockWithTxsImpl) then) =
      __$$PreConfirmedBlockWithTxsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'block_number') int blockNumber,
...
/// @nodoc
class __$$PreConfirmedBlockWithTxsImplCopyWithImpl<$Res>
    extends _$PreConfirmedBlockWithTxsCopyWithImpl<$Res,
        _$PreConfirmedBlockWithTxsImpl>
    implements _$$PreConfirmedBlockWithTxsImplCopyWith<$Res> {
  __$$PreConfirmedBlockWithTxsImplCopyWithImpl(
      _$PreConfirmedBlockWithTxsImpl _value,
      $Res Function(_$PreConfirmedBlockWithTxsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PreConfirmedBlockWithTxsImpl(
      blockNumber: null == blockNumber
          ? _value.blockNumber
          : blockNumber // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$PreConfirmedBlockWithTxsImpl implements _PreConfirmedBlockWithTxs {
  const _$PreConfirmedBlockWithTxsImpl(
      ...
      @JsonKey(
          fromJson: _preConfirmedTxnWithHashListFromJson,
          toJson: _preConfirmedTxnWithHashListToJson)
      required final List<TxnWithHash> transactions})
      : _transactions = transactions;

  factory _$PreConfirmedBlockWithTxsImpl.fromJson(Map<String, dynamic> json) =>
      _$$PreConfirmedBlockWithTxsImplFromJson(json);
  ...
  final List<TxnWithHash> _transactions;
  @override
  @JsonKey(
      fromJson: _preConfirmedTxnWithHashListFromJson,
      toJson: _preConfirmedTxnWithHashListToJson)
  List<TxnWithHash> get transactions {
  ...
  @override
  String toString() {
    return 'PreConfirmedBlockWithTxs(blockNumber: $blockNumber, timestamp: $timestamp, sequencerAddress: $sequencerAddress, l1GasPrice: $l1GasPrice, l2GasPrice: $l2GasPrice, l1DataGasPrice: $l1DataGasPrice, l1DaMode: $l1DaMode, starknetVersion: $starknetVersion, transactions: $transactions)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PreConfirmedBlockWithTxsImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PreConfirmedBlockWithTxsImplCopyWith<_$PreConfirmedBlockWithTxsImpl>
      get copyWith => __$$PreConfirmedBlockWithTxsImplCopyWithImpl<
          _$PreConfirmedBlockWithTxsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PreConfirmedBlockWithTxsImplToJson(
      this,
    );
  }
}

abstract class _PreConfirmedBlockWithTxs implements PreConfirmedBlockWithTxs {
  const factory _PreConfirmedBlockWithTxs(
      ...
      @JsonKey(
          fromJson: _preConfirmedTxnWithHashListFromJson,
          toJson: _preConfirmedTxnWithHashListToJson)
      required final List<TxnWithHash>
          transactions}) = _$PreConfirmedBlockWithTxsImpl;

  factory _PreConfirmedBlockWithTxs.fromJson(Map<String, dynamic> json) =
      _$PreConfirmedBlockWithTxsImpl.fromJson;
