...
_$ConfirmedBlockWithTxsImpl _$$ConfirmedBlockWithTxsImplFromJson(
    ...
    _$ConfirmedBlockWithTxsImpl(
      ...
      transactions: _txnWithHashListFromJson(json['transactions'] as List),
    );

Map<String, dynamic> _$$ConfirmedBlockWithTxsImplToJson(
        _$ConfirmedBlockWithTxsImpl instance) =>
    <String, dynamic>{
      ...
      'transactions': _txnWithHashListToJson(instance.transactions),
    };
