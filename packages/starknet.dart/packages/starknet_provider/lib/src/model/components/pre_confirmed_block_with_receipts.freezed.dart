...
part of 'pre_confirmed_block_with_receipts.dart';
...
PreConfirmedBlockWithReceipts _$PreConfirmedBlockWithReceiptsFromJson(
    Map<String, dynamic> json) {
  return _PreConfirmedBlockWithReceipts.fromJson(json);
}

/// @nodoc
mixin _$PreConfirmedBlockWithReceipts {
  ...
  /// Serializes this PreConfirmedBlockWithReceipts to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PreConfirmedBlockWithReceipts
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PreConfirmedBlockWithReceiptsCopyWith<PreConfirmedBlockWithReceipts>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PreConfirmedBlockWithReceiptsCopyWith<$Res> {
  factory $PreConfirmedBlockWithReceiptsCopyWith(
          PreConfirmedBlockWithReceipts value,
          $Res Function(PreConfirmedBlockWithReceipts) then) =
      _$PreConfirmedBlockWithReceiptsCopyWithImpl<$Res,
...
/// @nodoc
class _$PreConfirmedBlockWithReceiptsCopyWithImpl<$Res,
        $Val extends PreConfirmedBlockWithReceipts>
    implements $PreConfirmedBlockWithReceiptsCopyWith<$Res> {
  _$PreConfirmedBlockWithReceiptsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PreConfirmedBlockWithReceiptsImplCopyWith<$Res>
    implements $PreConfirmedBlockWithReceiptsCopyWith<$Res> {
  factory _$$PreConfirmedBlockWithReceiptsImplCopyWith(
          _$PreConfirmedBlockWithReceiptsImpl value,
          $Res Function(_$PreConfirmedBlockWithReceiptsImpl) then) =
      __$$PreConfirmedBlockWithReceiptsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'block_number') int blockNumber,
...
/// @nodoc
class __$$PreConfirmedBlockWithReceiptsImplCopyWithImpl<$Res>
    extends _$PreConfirmedBlockWithReceiptsCopyWithImpl<$Res,
        _$PreConfirmedBlockWithReceiptsImpl>
    implements _$$PreConfirmedBlockWithReceiptsImplCopyWith<$Res> {
  __$$PreConfirmedBlockWithReceiptsImplCopyWithImpl(
      _$PreConfirmedBlockWithReceiptsImpl _value,
      $Res Function(_$PreConfirmedBlockWithReceiptsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PreConfirmedBlockWithReceiptsImpl(
      blockNumber: null == blockNumber
          ? _value.blockNumber
          : blockNumber // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$PreConfirmedBlockWithReceiptsImpl
    implements _PreConfirmedBlockWithReceipts {
  const _$PreConfirmedBlockWithReceiptsImpl(
  ...
  factory _$PreConfirmedBlockWithReceiptsImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$PreConfirmedBlockWithReceiptsImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PreConfirmedBlockWithReceipts(blockNumber: $blockNumber, timestamp: $timestamp, sequencerAddress: $sequencerAddress, l1GasPrice: $l1GasPrice, l2GasPrice: $l2GasPrice, l1DataGasPrice: $l1DataGasPrice, l1DaMode: $l1DaMode, starknetVersion: $starknetVersion, transactions: $transactions)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PreConfirmedBlockWithReceiptsImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PreConfirmedBlockWithReceiptsImplCopyWith<
          _$PreConfirmedBlockWithReceiptsImpl>
      get copyWith => __$$PreConfirmedBlockWithReceiptsImplCopyWithImpl<
          _$PreConfirmedBlockWithReceiptsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PreConfirmedBlockWithReceiptsImplToJson(
      this,
    );
  }
}

abstract class _PreConfirmedBlockWithReceipts
    implements PreConfirmedBlockWithReceipts {
  const factory _PreConfirmedBlockWithReceipts(
      ...
      required final List<TransactionWithReceipt>
          transactions}) = _$PreConfirmedBlockWithReceiptsImpl;

  factory _PreConfirmedBlockWithReceipts.fromJson(Map<String, dynamic> json) =
      _$PreConfirmedBlockWithReceiptsImpl.fromJson;
