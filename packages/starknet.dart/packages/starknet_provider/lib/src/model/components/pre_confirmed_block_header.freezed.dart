...
PreConfirmedBlockHeader _$PreConfirmedBlockHeaderFromJson(
    Map<String, dynamic> json) {
  return _PreConfirmedBlockHeader.fromJson(json);
}

/// @nodoc
mixin _$PreConfirmedBlockHeader {
  ...
  /// Serializes this PreConfirmedBlockHeader to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PreConfirmedBlockHeader
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PreConfirmedBlockHeaderCopyWith<PreConfirmedBlockHeader> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PreConfirmedBlockHeaderCopyWith<$Res> {
  factory $PreConfirmedBlockHeaderCopyWith(PreConfirmedBlockHeader value,
          $Res Function(PreConfirmedBlockHeader) then) =
      _$PreConfirmedBlockHeaderCopyWithImpl<$Res, PreConfirmedBlockHeader>;
  @useResult
  $Res call(
...
/// @nodoc
class _$PreConfirmedBlockHeaderCopyWithImpl<$Res,
        $Val extends PreConfirmedBlockHeader>
    implements $PreConfirmedBlockHeaderCopyWith<$Res> {
  _$PreConfirmedBlockHeaderCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PreConfirmedBlockHeaderImplCopyWith<$Res>
    implements $PreConfirmedBlockHeaderCopyWith<$Res> {
  factory _$$PreConfirmedBlockHeaderImplCopyWith(
          _$PreConfirmedBlockHeaderImpl value,
          $Res Function(_$PreConfirmedBlockHeaderImpl) then) =
      __$$PreConfirmedBlockHeaderImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'block_number') int blockNumber,
...
/// @nodoc
class __$$PreConfirmedBlockHeaderImplCopyWithImpl<$Res>
    extends _$PreConfirmedBlockHeaderCopyWithImpl<$Res,
        _$PreConfirmedBlockHeaderImpl>
    implements _$$PreConfirmedBlockHeaderImplCopyWith<$Res> {
  __$$PreConfirmedBlockHeaderImplCopyWithImpl(
      _$PreConfirmedBlockHeaderImpl _value,
      $Res Function(_$PreConfirmedBlockHeaderImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PreConfirmedBlockHeaderImpl(
      blockNumber: null == blockNumber
          ? _value.blockNumber
          : blockNumber // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$PreConfirmedBlockHeaderImpl implements _PreConfirmedBlockHeader {
  const _$PreConfirmedBlockHeaderImpl(
  ...
  factory _$PreConfirmedBlockHeaderImpl.fromJson(Map<String, dynamic> json) =>
      _$$PreConfirmedBlockHeaderImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PreConfirmedBlockHeader(blockNumber: $blockNumber, timestamp: $timestamp, sequencerAddress: $sequencerAddress, l1GasPrice: $l1GasPrice, l2GasPrice: $l2GasPrice, l1DataGasPrice: $l1DataGasPrice, l1DaMode: $l1DaMode, starknetVersion: $starknetVersion)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PreConfirmedBlockHeaderImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PreConfirmedBlockHeaderImplCopyWith<_$PreConfirmedBlockHeaderImpl>
      get copyWith => __$$PreConfirmedBlockHeaderImplCopyWithImpl<
          _$PreConfirmedBlockHeaderImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PreConfirmedBlockHeaderImplToJson(
      this,
    );
  }
}

abstract class _PreConfirmedBlockHeader implements PreConfirmedBlockHeader {
  const factory _PreConfirmedBlockHeader(
      ...
      @JsonKey(name: 'starknet_version')
      required final String starknetVersion}) = _$PreConfirmedBlockHeaderImpl;

  factory _PreConfirmedBlockHeader.fromJson(Map<String, dynamic> json) =
      _$PreConfirmedBlockHeaderImpl.fromJson;
