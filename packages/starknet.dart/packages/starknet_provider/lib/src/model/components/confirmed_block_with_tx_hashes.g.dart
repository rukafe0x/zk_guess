...
_$ConfirmedBlockWithTxHashesImpl _$$ConfirmedBlockWithTxHashesImplFromJson(
...
Map<String, dynamic> _$$ConfirmedBlockWithTxHashesImplToJson(
        _$ConfirmedBlockWithTxHashesImpl instance) =>
    <String, dynamic>{
