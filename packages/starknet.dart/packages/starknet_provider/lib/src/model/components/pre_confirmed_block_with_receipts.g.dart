...
_$PreConfirmedBlockWithReceiptsImpl
    _$$PreConfirmedBlockWithReceiptsImplFromJson(Map<String, dynamic> json) =>
        _$PreConfirmedBlockWithReceiptsImpl(
          ...
          transactions: (json['transactions'] as List<dynamic>)
              .map((e) =>
                  TransactionWithReceipt.fromJson(e as Map<String, dynamic>))
              .toList(),
        );

Map<String, dynamic> _$$PreConfirmedBlockWithReceiptsImplToJson(
        _$PreConfirmedBlockWithReceiptsImpl instance) =>
    <String, dynamic>{
