...
Future<void> initApp() => RustLib.instance.api.moproExampleApp2InitApp();

/// You can also customize the bindings by #[uniffi::export]
/// Reference: https://mozilla.github.io/uniffi-rs/latest/proc_macro/index.html
Future<String> moproHelloWorld() =>
    RustLib.instance.api.moproExampleApp2MoproHelloWorld();

Future<String> moproWasmHelloWorld() =>
    RustLib.instance.api.moproExampleApp2MoproWasmHelloWorld();

/// Build Starknet-compatible Groth16 calldata (BN254) from a [`CircomProofResult`].
///
/// Prove with [`super::generate_circom_proof`], then pass the result here along with a
/// one-time SnarkJS verification-key export from your zkey.
///
/// `verification_key_json` — contents of `snarkjs zkey export verificationkey ... verification_key.json`
///
...
Future<List<String>> generateCircomGroth16GaragaCalldata(
    ...
    RustLib.instance.api.moproExampleApp2GenerateCircomGroth16GaragaCalldata(
...
Future<CircomProofResult> generateCircomProof(
    ...
    RustLib.instance.api.moproExampleApp2GenerateCircomProof(
...
Future<bool> verifyCircomProof(
        ...
        required CircomProofResult proofResult,
        required ProofLib proofLib}) =>
    RustLib.instance.api.moproExampleApp2VerifyCircomProof(
...
Future<Halo2ProofResult> generateHalo2Proof(
    ...
    RustLib.instance.api.moproExampleApp2GenerateHalo2Proof(
...
Future<bool> verifyHalo2Proof(
    ...
    RustLib.instance.api.moproExampleApp2VerifyHalo2Proof(
        srsPath: srsPath,
        vkPath: vkPath,
        proof: proof,
...
Future<Uint8List> generateNoirProof(
    ...
    RustLib.instance.api.moproExampleApp2GenerateNoirProof(
...
Future<bool> verifyNoirProof(
        ...
        required List<int> vk,
        required bool lowMemoryMode}) =>
    RustLib.instance.api.moproExampleApp2VerifyNoirProof(
        circuitPath: circuitPath,
        proof: proof,
        onChain: onChain,
        vk: vk,
...
Future<Uint8List> getNoirVerificationKey(
        ...
        required bool onChain,
        required bool lowMemoryMode}) =>
    RustLib.instance.api.moproExampleApp2GetNoirVerificationKey(
        circuitPath: circuitPath,
        srsPath: srsPath,
        onChain: onChain,
        lowMemoryMode: lowMemoryMode);
...
Future<GnarkProofResult> generateGnarkProof(
    ...
    RustLib.instance.api.moproExampleApp2GenerateGnarkProof(
...
Future<bool> verifyGnarkProof(
    ...
    RustLib.instance.api.moproExampleApp2VerifyGnarkProof(
...
class CircomProof {
  ...
  static Future<CircomProof> default_() =>
      RustLib.instance.api.moproExampleApp2CircomProofDefault();
...
class G1 {
  ...
  static Future<G1> default_() =>
      RustLib.instance.api.moproExampleApp2G1Default();
...
class G2 {
  ...
  static Future<G2> default_() =>
      RustLib.instance.api.moproExampleApp2G2Default();
...
class Halo2ProofResult {
  ...
  static Future<Halo2ProofResult> default_() =>
      RustLib.instance.api.moproExampleApp2Halo2ProofResultDefault();
...
enum ProofLib {
  ...
  static Future<ProofLib> default_() =>
      RustLib.instance.api.moproExampleApp2ProofLibDefault();
}
