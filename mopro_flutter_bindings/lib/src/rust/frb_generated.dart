...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<String>> moproExampleApp2GenerateCircomGroth16GaragaCalldata(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(verificationKeyJson, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 4, port: port_);
      },
      codec: SseCodec(
  ...
  CircomProof sse_decode_circom_proof(SseDeserializer deserializer) {
    ...
    return CircomProof(
        a: var_a, b: var_b, c: var_c, protocol: var_protocol, curve: var_curve);
  }
  ...
  void
      sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerMoproError(
          MoproError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as MoproErrorImpl).frbInternalSseEncode(move: true), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as MoproErrorImpl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  void sse_encode_box_autoadd_circom_proof_result(
      CircomProofResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_box_autoadd_gnark_proof_result(
      GnarkProofResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_halo_2_proof_result(
      Halo2ProofResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
